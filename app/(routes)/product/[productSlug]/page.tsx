...
export default function Page() {
  ...
  const { result: product } = useGetProductBySlug(productSlug);
  const [currentIndex, setCurrentIndex] = useState(0);

  // Mientras no tengamos el producto, solo se muestra el SkeletonProduct.
  if (!product) {
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 mt-6 sm:mt-8">
        ...
        <Accordion type="multiple">
          ...
          <AccordionItem value="item-6">
            ...
            <AccordionContent>
              Solo recopilamos la información necesaria (correo, datos generales
              y DNI) para gestionar tus pedidos y envíos. Tus datos se mantienen
